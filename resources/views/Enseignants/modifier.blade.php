        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <form method="POST" action="{{route('enseignants.update', [$enseignants->id])}}" class="row g-3">
                @method('PATCH')
                @csrf
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="telephone" value="{{ $enseignants->telephone}}">
              </div>
