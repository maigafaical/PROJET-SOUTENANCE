          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <div class="col-md-6">
                ...
                <input type="date" class="form-control" name="date_naissance" value="{{ $etudiants->date_naissance}}">
              </div>

              <div class="col-6">
                <label for="inputAddress5" class="form-label">Sexe</label>
                <input type="text" class="form-control" name="sexe" value="{{ $etudiants->sexe}}">
              </div>

              <div class="col-6">
                <label for="inputAddress5" class="form-label">Téléphone étudiant</label>
                <input type="number" class="form-control" name="phone_etudiant" value="{{ $etudiants->phone_etudiant}}">
              </div>
              ...
              <div class="col-6">
                ...
                <input type="text" class="form-control" name="filiere" value="{{ $etudiants->filiere}}">
              </div>
