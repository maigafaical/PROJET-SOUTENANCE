        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <form method="POST" action="{{route('salles.update', $salles->id )}}" class="row g-3">
                @method('PATCH')
                @csrf
              <div class="col-md-6">
                <label for="inputName5" class="form-label">Nom de la salle </label>
                <input type="text" class="form-control" name="nom_salle"  value="{{ $salles->nom_salle}}">
              </div>
              @csrf
              <div class="col-md-6">
                <label for="inputEmail5" class="form-label">Capacité de la salle</label>
                <input type="number" class="form-control" name="capacite"  value="{{ $salles->capacite}}">
              </div>
